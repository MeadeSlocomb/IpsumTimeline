...
this["template"] = this["template"] || {};
this["template"]["ipsum"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  return "<div class=\"topSpace\"></div>\n\n\n"
    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.objects : depth0),{"name":"each","hash":{},"fn":this.program(1, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
    + "\n";
},"useData":true});